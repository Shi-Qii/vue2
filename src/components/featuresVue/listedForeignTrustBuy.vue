    ...
    onMounted(() => {
      ...
      GetStockData.getUserBoard(selectKey).then(res => {
        ...
        individualVueData.fields.value = [{
          ...
          {key: 'addUp', label: '外資+投信', thClass: 'text-center ', tdClass: 'text-center', sortable: true},
          {
          ...
          {key: 'Total_buysell', label: '總買', thClass: 'text-center', tdClass: 'text-center ', sortable: true}]
    ...
    const allFunction = reactive({
      editHTMLcolorClassification: (res) => {
        ...
        individualVueData.items.value.forEach((f, index, arr) => {
          f['addUp']=f['Investment_trust']+f['Foreign_investors'];
