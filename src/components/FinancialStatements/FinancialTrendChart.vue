<template>
  <div>
    <div class="container-fluid">
      ...
      <FinancialTrendSpline v-if="showState.showTable" :initChartData="initChartData"></FinancialTrendSpline>
...
*/
    ...
    return {stockCode, search, datalists, vueData, showState, selected2, initChartData}
  }
