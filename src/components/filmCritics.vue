...
<template>
  ...
  <div class="make-container">
    ...
    <b-button type="button" pill variant="info" @click="refreshTheater()"
      >首頁</b-button
    >
    <b-button type="button" pill variant="info" @click="selectType('action')"
      >動作</b-button
    >
    <b-button type="button" pill variant="info" @click="selectType('love')"
      >愛情</b-button
    >
    <b-button type="button" pill variant="info" @click="selectType('Horror')"
      >恐怖</b-button
    >
  ...
  methods: {
    refreshTheater() {
      theaterDataService.retrieveAllCourses(this.INSTRUCTOR).then((res) => {
        ...
        this.loadImage = API_URL + "getImage/img_03_311733.jpg"
      });
